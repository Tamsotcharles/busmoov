/**
 * Données SEO pures (aucun import) : partagées entre le composant Seo
 * (via src/lib/seo.ts) et le script de prérendu scripts/prerender.mjs,
 * qui importe ce fichier directement sous Node (type stripping natif).
 */

export type SeoLanguage = 'fr' | 'es' | 'de' | 'en'
